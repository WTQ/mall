    ...
    <form name="sysconfig" action="" method="post">
      <table width="100%" cellspacing="0">
        ...
        <tr>
          ...
          <td colspan="3" align="left" ><input class="text" name="validTime" type="text" id="validTime" value="<?php echo $reg_config['validTime'];?>" />
            <br />
            <span class="bz"> 7天|15天|1个月|3个月|6个月|1年|永久 <br />
            7 days|15 days|1 month|3 months|6 months|1 year|permanent</span></td>
        </tr>
        <tr>
          <td height="40" align="left">产品类型</td>
          <td colspan="3" align="left" ><input class="text" name="ptype" type="text" id="ptype" value="<?php echo $reg_config['ptype'];?>" />
            <br />
            <span class="bz">全新|二手|闲置|其它<br />
            New|Old|unused|Other</span></td>
        </tr>
        <tr>
